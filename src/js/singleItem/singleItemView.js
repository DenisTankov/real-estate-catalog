export function render(object, isFaved) {
   ...
   //isFaved - true или false. Находится ли объект в избранном

   const markup = `<div class="container p-0 pt-5">
                     <div class="heading-1">
                        ${object.title}, ${object.price_sq_m} м2 за ${object.price_total} ₽
                     </div>
                  ...
                  <div class="container p-0">
                     <a href="https://denistankov.github.io/real-estate-catalog/index.html" class="back-to-results"
                        >← Вернуться к результатам поиска</a
                     >
                  </div>`;

   //для модального окна добавлен класс none, скрываем при рендере
   const markupModal = `
...
//собираем данные с формы модального окна
...
export function toggleFavouritesBtn(isFaved) {
